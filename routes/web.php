...
Route::group(['middleware' => 'userlogin'], function () {
    ...
    Route::middleware(['checkRoleUser:/suplier,menu'])->group(function () {
        ...
        Route::get('/admin/suplier/show/', [suplierController::class, 'show'])->name('suplier.getsuplier');
        Route::post('/admin/suplier/proses_tambah/', [suplierController::class, 'proses_tambah'])->name('suplier.store');
        Route::post('/admin/suplier/proses_ubah/{suplier}', [suplierController::class, 'proses_ubah']);
        Route::post('/admin/suplier/proses_hapus/{suplier}', [suplierController::class, 'proses_hapus']);
    });
    ...
    Route::middleware(['checkRoleUser:/lap-barang-masuk,submenu'])->group(function () {
        ...
        Route::get('/admin/barang-keluar/print/barang', [BarangkeluarController::class, 'print']);
