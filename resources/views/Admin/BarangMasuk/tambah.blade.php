            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="suplier" class="form-label">Pilih suplier <span class="text-danger">*</span></label>
...
<script>
    ...
    function checkForm() {
        ...
        const suplier = $("select[name='suplier']").val();
        ...
        if (tglmasuk == "") {
            ...
            $("select[name='suplier']").addClass('is-invalid');
            setLoading(false);
            return false;
    ...
    function resetValid() {
        ...
        $("select[name='suplier']").removeClass('is-invalid');
