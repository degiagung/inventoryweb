            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="suplierU" class="form-label">Pilih suplier <span class="text-danger">*</span></label>
                            <select name="suplierU" id="suplierU" class="form-control">
                                <option value="">-- Pilih suplier --</option>
                                @foreach ($suplier as $c)
                                <option value="{{ $c->suplier_id }}">{{ $c->suplier_nama }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
...
<script>
    ...
    function checkFormU() {
        ...
        const suplier = $("select[name='suplierU']").val();
        ...
        if (tglmasuk == "") {
            ...
            validasi('suplier wajib di pilih!', 'warning');
            $("select[name='suplierU']").addClass('is-invalid');
            setLoadingU(false);
            return false;
    ...
    function resetValidU() {
        ...
        $("select[name='suplierU']").removeClass('is-invalid');
