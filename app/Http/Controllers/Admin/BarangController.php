...
class BarangController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('totalstok', function ($row) use ($request) {
                    if ($request->tglawal == '') {
                        $jmlmasuk = BarangmasukModel::leftJoin('tbl_barang', 'tbl_barang.barang_kode', '=', 'tbl_barangmasuk.barang_kode')->leftJoin('tbl_suplier', 'tbl_suplier.suplier_id', '=', 'tbl_barangmasuk.suplier_id')->where('tbl_barangmasuk.barang_kode', '=', $row->barang_kode)->sum('tbl_barangmasuk.bm_jumlah');
                    } else {
                        $jmlmasuk = BarangmasukModel::leftJoin('tbl_barang', 'tbl_barang.barang_kode', '=', 'tbl_barangmasuk.barang_kode')->leftJoin('tbl_suplier', 'tbl_suplier.suplier_id', '=', 'tbl_barangmasuk.suplier_id')->whereBetween('bm_tanggal', [$request->tglawal, $request->tglakhir])->where('tbl_barangmasuk.barang_kode', '=', $row->barang_kode)->sum('tbl_barangmasuk.bm_jumlah');
                    }
    ...
    public function proses_ubah(Request $request, BarangModel $barang)
    {
        ...
        if ($request->hasFile('foto')) {
            ...
            $barang->update([
                'barang_gambar'  => $nama_file_upload,
                'jenisbarang_id' => $request->jenisbarang,
                'satuan_id' => $request->satuan,
                'merk_id' => $request->merk,
                'barang_kode' => $request->kode,
