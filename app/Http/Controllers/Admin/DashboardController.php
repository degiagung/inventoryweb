...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $data["suplier"] = SuplierModel::orderBy('suplier_id', 'DESC')->count();
        $data["bm"] = BarangmasukModel::leftJoin('tbl_barang', 'tbl_barang.barang_kode', '=', 'tbl_barangmasuk.barang_kode')->leftJoin('tbl_suplier', 'tbl_suplier.suplier_id', '=', 'tbl_barangmasuk.suplier_id')->orderBy('bm_id', 'DESC')->count();
